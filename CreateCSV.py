...
#  declaring path to save faces
path_images_from_camera = "data/Registered_Faces/"

#  using frontal face detector of dlib
detector = dlib.get_frontal_face_detector()

#  using shape predictor landmarks model of dlib/ will give us coordinates of all 68 points of face
predictor = dlib.shape_predictor('data/dlib_Models/shape_predictor_68_face_landmarks.dat')

#  using dlib resnet 50 model to get 128d face discriptor
face_reco_model = dlib.face_recognition_model_v1("data/dlib_Models/dlib_face_recognition_resnet_model_v1.dat")

# to return face features
...
#   to return mean value for student in frame
def return_features_mean_personX(path_face_personX):
    ...
    if photos_list:
        for i in range(len(photos_list)):
            ...
            #skip if no face detected in image
            if features_128d == 0:
                i += 1
            else:
...
# function to create CSV file from the features of faces
def main():
    ...
    with open("data/Student_Features.csv", "w", newline="") as csvfile:
        ...
        for person in person_list:
            ...
            logging.info('\n')
        logging.info("Save all the features of faces registered into: data/Student_Features.csv")
